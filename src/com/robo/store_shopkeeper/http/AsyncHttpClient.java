 ...
 * </pre>
 *
 * @see com.robo.store_shopkeeper.http.AsyncHttpResponseHandler
 * @see com.robo.store_shopkeeper.http.ResponseHandlerInterface
 * @see com.robo.store_shopkeeper.http.RequestParams
 */
public class AsyncHttpClient {
     ...
     * @see com.robo.store_shopkeeper.http.MyRedirectHandler
     */
    ...
    protected RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Context context) {
        ...
        LogUtil.DefalutLog("---URI---"+responseHandler.getRequestURI().toString());
