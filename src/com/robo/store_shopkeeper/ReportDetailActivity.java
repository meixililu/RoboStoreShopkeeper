...
public class ReportDetailActivity extends BaseActivity implements OnClickListener{
	...
	private TextView ruku_goods_report;
	private GetDamageInfoResponse mResponse;
	...
	private void init(){
		...
		ruku_goods_report = (TextView) findViewById(R.id.ruku_goods_report);
	...
	private void setData(){
		...
		ruku_goods_report.setText(mResponse.getDamageMemo());
	}
	...
	private void RequestData(){
		...
		params.put("shopId", "");
		params.put("damageId", instorageId);
		RoboHttpClient.post(HttpParameter.goodUrl,"getDamageInfo", params, new TextHttpResponseHandler(){
			
			@Override
			public void onFailure(int arg0, Header[] arg1, String arg2, Throwable arg3) {
				showEmptyLayout_Error();
				ToastUtil.diaplayMesLong(ReportDetailActivity.this, ReportDetailActivity.this.getResources().getString(R.string.connet_fail));
			}
			
			@Override
			public void onSuccess(int arg0, Header[] arg1, String result) {
				mResponse = (GetDamageInfoResponse) ResultParse.parseResult(result,GetDamageInfoResponse.class);
				if(ResultParse.handleResutl(ReportDetailActivity.this, mResponse)){
					setData();
				}else{
