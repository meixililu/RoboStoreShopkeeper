...
import com.robo.store_shopkeeper.adapter.RukuHistoryListAdapter;
import com.robo.store_shopkeeper.dao.GetInStrogeListResponse;
...
public class RukuHistoryActivity extends BaseActivity implements OnClickListener{

	private LayoutInflater inflater;
	private ListView mListView;
	private RukuHistoryListAdapter mRukuHistoryListAdapter;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ruku_history);
		init();
		RequestData();
	}
	...
	private void init(){
		...
		list = new ArrayList<GetInStrogeListVo>();
		mRukuHistoryListAdapter = new RukuHistoryListAdapter(this, inflater, list);
		initSwipeRefresh();
	...
	private void RequestData(){
		if(isFinishloadData){
			...
			RoboHttpClient.post(HttpParameter.goodUrl,"getInStrogeList", params, new TextHttpResponseHandler(){
				
				@Override
				public void onFailure(int arg0, Header[] arg1, String arg2, Throwable arg3) {
					ToastUtil.diaplayMesLong(RukuHistoryActivity.this, RukuHistoryActivity.this.getResources().getString(R.string.connet_fail));
				}
				
				@Override
				public void onSuccess(int arg0, Header[] arg1, String result) {
					GetInStrogeListResponse mResponse = (GetInStrogeListResponse) ResultParse.parseResult(result,GetInStrogeListResponse.class);
					if(ResultParse.handleResutl(RukuHistoryActivity.this, mResponse)){
