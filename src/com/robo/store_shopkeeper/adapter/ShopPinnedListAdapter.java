...
public class ShopPinnedListAdapter extends BaseAdapter implements PinnedSectionListAdapter {

	private Context context;
	private LayoutInflater mInflater;
	private List<ShopBase> AllDataList;
	
	public ShopPinnedListAdapter(Context mContext,LayoutInflater mInflater,List<ShopBase> shopList){
