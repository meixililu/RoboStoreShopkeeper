...
public class OrderType4Activity extends BaseActivity implements View.OnClickListener{
	...
	private void RequestData(){
		...
		RoboHttpClient.post(HttpParameter.orderUrl, "getSingleOrder", params, new TextHttpResponseHandler(){
			...
			public void onFailure(int arg0, Header[] arg1, String arg2, Throwable arg3) {
				ToastUtil.diaplayMesLong(OrderType4Activity.this, "连接失败，请重试！");
			...
			public void onSuccess(int arg0, Header[] arg1, String result) {
				...
				if(ResultParse.handleResutl(OrderType4Activity.this, mSingleOrder)){
...
//		.into(good_icon);
		...
		get_goods_shop.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				ToastUtil.diaplayMesShort(OrderType4Activity.this, "取货店铺信息");
			}
		});
		return goodsView;
	}
