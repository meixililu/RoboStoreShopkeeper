...
public class OrderType1Activity extends BaseActivity implements View.OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_order_type1);
		init();
		RequestData();
	}
	...
	private void init(){
		...
		order_cancle_cover = (FrameLayout) findViewById(R.id.order_cancle_cover);
	...
	private void setData(GetSingleOrderResponse mSingleOrder){
		...
		sum_tv.setText("￥"+mSingleOrder.getMallOrderCode());
	...
	private void RequestData(){
		...
		RoboHttpClient.post(HttpParameter.orderUrl, "getSingleOrder", params, new TextHttpResponseHandler(){
			...
			public void onSuccess(int arg0, Header[] arg1, String result) {
				...
				if(ResultParse.handleResutl(OrderType1Activity.this, mSingleOrder)){
...
//		.into(good_icon);
		...
		get_goods_shop.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				ToastUtil.diaplayMesShort(OrderType1Activity.this, "取货店铺信息");
			}
		});
		return goodsView;
	}
